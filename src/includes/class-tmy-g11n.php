...
class TMY_G11n {
	...
	private function define_admin_hooks() {
		...
		//$this->loader->add_filter( 'update_option_g11n_l10n_props_pages', $plugin_admin, 'tmy_plugin_option_update_after', 10, 3 );
                ...
                //$this->loader->add_action( 'bulk_actions-edit-g11n_translation', $plugin_admin,'tmy_plugin_g11n_translation_bulk_actions',10,1);
                //$this->loader->add_filter( 'handle_bulk_actions-edit-g11n_translation', $plugin_admin,'tmy_plugin_g11n_translation_bulk_actions_handler',10,3);
                ...
                $this->loader->add_action( 'save_post', $plugin_admin, 'tmy_plugin_g11n_save_post_filter' );
	...
	private function define_public_hooks() {
		...
		$this->loader->add_filter( 'fusion_layout_section_id', $plugin_public, 'g11n_ext_translator_filter', 10, 4 );
                ...
                $this->loader->add_filter( 'fusion_builder_default_args', $plugin_public, 'g11n_fusion_default_args_filter', 10, 3 );
